    ...
    <Card className="w-[600px] shadow-md">
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-row items-center justify-between rounded-lg p-3 shadow-sm">
          ...
          <p className="text-xs truncate max-w-[200px] font-mono p-1 bg-slate-100 rounded-md">
            {user?.id}
          </p>
        </div>
        <div className="flex flex-row items-center justify-between rounded-lg p-3 shadow-sm">
        ...
        <div className="flex flex-row items-center justify-between rounded-lg p-3 shadow-sm">
          ...
          <p className="text-xs truncate max-w-fit font-mono p-1 bg-slate-100 rounded-md">
            {user?.email}
          </p>
        </div>
        <div className="flex flex-row items-center justify-between rounded-lg p-3 shadow-sm">
